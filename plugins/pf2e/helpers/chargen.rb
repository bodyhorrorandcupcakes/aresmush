module AresMUSH
  module Pf2e
    ...
    def self.cg_set_ancestry(char, slug)
      ...
      return { ok: false, error: "pf2e.cg_ancestry_not_open", sheet: sheet } unless cg_ancestry_open?(key)
    ...
    def self.cg_set_heritage(char, slug)
      ...
      return { ok: false, error: "pf2e.cg_heritage_not_open", sheet: sheet } unless cg_heritage_open?(key)
